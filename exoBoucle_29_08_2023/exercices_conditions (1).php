<html>
    ...
    <body>
        ...
        <?php
            ...
            echo "Plus grand nombre entre -5,7,4 : " . getLowest(-5, 7, 4) . "<br>";
            echo "Plus grand nombre entre 7,7,4 : " . getLowest(7, 7, 4) . "<br>";
            echo "Plus grand nombre entre -5,4,4 : " . getLowest(-5, 4, 4) . "<br>";
            echo "Plus grand nombre entre -5,4,4 : " . getLowest(-23, -2, -6) . "<br>";
        ?>
